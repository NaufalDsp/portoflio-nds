      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {mobileOpen ? (
                <X size={18} className={isDark ? 'text-white' : 'text-slate-800'} />
              ) : (
                <Menu size={18} className={isDark ? 'text-white' : 'text-slate-800'} />
              )}
            </button>
          </div>
        </div>
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-3">
              {navLinks.map(link => (
                <button
                  ...
                  className={`text-left text-sm py-2 transition-colors duration-200 ${
                    isDark ? 'text-[#A0A8C0] hover:text-white' : 'text-slate-500 hover:text-slate-900'
                  }`}
                >
                  {link.label}
                </button>
              ...
              <a
                ...
                style={{ background: 'linear-gradient(135deg, #4FACFE 0%, #A855F7 100%)', fontWeight: 600 }}
              >
                <Download size={15} />
                Resume
              </a>
