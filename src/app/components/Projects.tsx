...
const projects = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1770734360042-676ef707d022?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXJrJTIwd2ViJTIwYXBwJTIwZGFzaGJvYXJkJTIwVUklMjBtb2Rlcm58ZW58MXx8fHwxNzcyNjA2Nzk0fDA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1629362050323-b40efaa4c217?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjBzaG9wJTIwcHJvZHVjdCUyMGRhcmslMjB0ZWNofGVufDF8fHx8MTc3MjYwNjc5OXww&ixlib=rb-4.1.0&q=80&w=1080',
    tags: ['Next.js', 'Node.js', 'MongoDB', 'Stripe'],
    tagColors: ['#4FACFE', '#34D399', '#F59E0B', '#A855F7'],
    github: '#',
    live: '#',
    featured: false,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1584651432430-7e1ac8303a0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBzb2NpYWwlMjBtZWRpYSUyMGFwcCUyMG5lb24lMjBkYXJrfGVufDF8fHx8MTc3MjYwNjc5NXww&ixlib=rb-4.1.0&q=80&w=1080',
    tags: ['React Native', 'Firebase', 'GraphQL', 'Redux'],
    tagColors: ['#4FACFE', '#F59E0B', '#A855F7', '#34D399'],
    github: '#',
    live: '#',
    featured: false,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1511140973288-19bf21d7e771?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwb3J0Zm9saW8lMjB3ZWJzaXRlJTIwZGVzaWduJTIwY3JlYXRpdmUlMjBkYXJrfGVufDF8fHx8MTc3MjYwNjc5Nnww&ixlib=rb-4.1.0&q=80&w=1080',
    tags: ['Three.js', 'GSAP', 'React', 'Vite'],
    tagColors: ['#34D399', '#F59E0B', '#4FACFE', '#A855F7'],
    github: '#',
    live: '#',
    featured: false,
  },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to bottom, transparent, #4FACFE)' }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <p style={{ color: isDark ? '#6B7080' : '#6B7280', maxWidth: 500, margin: '0 auto', fontSize: '0.95rem' }}>
            A curated selection of projects that demonstrate my passion for clean code and beautiful interfaces.
          </p>
        </motion.div>
